...
(function( $ ){
  ...
  var methods = {
    ...
    open : function(el){
 		...
 		el.animate({width: el.data('settings').openedSize+"%"}, {duration:el.data('settings').animTime, queue:false});     
		$(el.data('settings').content).animate({width: el.data('settings').openedSize+"%"}, {duration:el.data('settings').animTime, queue:false}); 
